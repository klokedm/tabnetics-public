...
The current HDLSS browser bundle exposes the refreshed local slice: **57,217** run rows across **278** profiles and **70** datasets, including the Val-21 phase-2 RV holdout.
...
| Val-21 Phase 1 | `val21_phase1` | Full benchmark panel | 7 | 63 | Val-21 Current Default, Val-21 Integrated, Val-21 Winner, Val-21 Winner Lockout, Val-21 Winner Meta-Selector, Val-21 Winner Prefilter, Val-21 Winner Regime | Public browser slice for this campaign. |
| Val-21 Phase 2 | `val21_phase2` | Diagnostic subset | 3 | 8 | Val-21 Current Default, Val-21 Winner, Val-21 Winner Lockout | Public browser slice for this campaign. |
...
| Val-21 Current Default | `V21_CURRENT_DEFAULT` | 1 | 66 | Full benchmark panel, Diagnostic subset | Val-21 Phase 1, Val-21 Phase 2 | Public browser family in the benchmark bundle. |
| Val-21 Integrated | `V21_INTEGRATED` | 1 | 63 | Full benchmark panel | Val-21 Phase 1 | Public browser family in the benchmark bundle. |
| Val-21 Winner | `V21_WINNER` | 1 | 66 | Full benchmark panel, Diagnostic subset | Val-21 Phase 1, Val-21 Phase 2 | Public browser family in the benchmark bundle. |
| Val-21 Winner Lockout | `V21_WINNER_LOCKOUT` | 1 | 66 | Full benchmark panel, Diagnostic subset | Val-21 Phase 1, Val-21 Phase 2 | Public browser family in the benchmark bundle. |
| Val-21 Winner Meta-Selector | `V21_WINNER_METASEL` | 1 | 63 | Full benchmark panel | Val-21 Phase 1 | Public browser family in the benchmark bundle. |
| Val-21 Winner Prefilter | `V21_WINNER_PREFILTER` | 1 | 63 | Full benchmark panel | Val-21 Phase 1 | Public browser family in the benchmark bundle. |
| Val-21 Winner Regime | `V21_WINNER_REGIME` | 1 | 63 | Full benchmark panel | Val-21 Phase 1 | Public browser family in the benchmark bundle. |
...
| BASEHOCK Text (Scikit-feature) (`rv_basehock`) | Easy | genomics | cDNA | 1,993 / 4,862 | P14_lowpn_fast_filter | 0.85-0.93 (above) |
...
| COIL20 Objects (Scikit-feature) (`rv_coil20`) | Medium | genomics | cDNA | 1,440 / 1,024 | V21_CURRENT_DEFAULT | 0.92-0.99 (above) |
...
| GISETTE (NIPS 2003 FS Challenge) (`gisette_nips03`) | Medium | non_genomic | cDNA | 7,000 / 5,000 | P15_lowpn_all_features | 0.75-0.89 (above) |
...
| ISOLET Audio (Scikit-feature) (`rv_isolet`) | Hard | genomics | cDNA | 1,560 / 617 | V21_CURRENT_DEFAULT | 0.85-0.95 (within) |
...
| Lymphoma-11 (OpenML) (`lymphoma_11`) | Hard | genomics | Affy HG-U133A | 96 / 4,026 | V21_WINNER_REGIME | 0.45-0.65 (above) |
| Lymphoma-3 (OpenML) (`lymphoma_3`) | Medium | genomics | Affy HG-U133A | 66 / 4,026 | A01_simple_anchor_after_fs | 0.80-0.90 (above) |
| Lymphoma-9 (OpenML) (`lymphoma_9`) | Hard | genomics | Affy HG-U133A | 96 / 4,026 | V21_WINNER_REGIME | 0.50-0.70 (above) |
...
| PCMAC Text (Scikit-feature) (`rv_pcmac`) | Medium | genomics | cDNA | 1,943 / 3,289 | V21_CURRENT_DEFAULT | 0.80-0.90 (within) |
...
| RELATHE Text (Scikit-feature) (`rv_relathe`) | Medium | genomics | cDNA | 1,427 / 4,322 | V21_WINNER | 0.82-0.92 (within) |
...
| TCGA-KIRC Kidney Clear Cell (Xena, stage-based) (`xena_tcga_kirc`) | Hard | genomics | cDNA | 606 / 20,530 | V21_WINNER | 0.50-0.68 (below) |
...
| TCGA-OV Ovarian (Xena, histologic grade G2 vs G3) (`xena_tcga_ov`) | Hard | genomics | cDNA | 299 / 20,530 | V21_WINNER_PREFILTER | 0.48-0.65 (above) |
...
| TCGA-SKCM Melanoma (Xena, primary vs metastatic) (`xena_tcga_skcm`) | Hard | genomics | cDNA | 472 / 20,530 | V21_WINNER_METASEL | 0.78-0.90 (within) |
...
| TCGA-UCEC Uterine (Xena, histological 3-type) (`xena_tcga_ucec`) | Hard | genomics | cDNA | 190 / 20,530 | V21_WINNER | 0.50-0.68 (above) |
| TOX_171 (Scikit-feature) (`tox_171`) | Medium | genomics | cDNA | 171 / 5,748 | A01_simple_anchor_after_fs | 0.84-0.93 (above) |
| USPS Handwritten Digits (Scikit-feature) (`rv_usps`) | Easy | genomics | cDNA | 9,298 / 256 | V21_CURRENT_DEFAULT | 0.90-0.97 (within) |
| warpAR10P (Scikit-feature, Face) (`rv_warpar10p`) | Medium | genomics | cDNA | 130 / 2,400 | V21_CURRENT_DEFAULT | 0.70-0.85 (above) |
| warpPIE10P (Face) (`warp_pie10p`) | Easy | non_genomic | cDNA | 210 / 2,420 | A07_ref_before_fs | 0.95-1.00 (within) |
| Yale Faces (Scikit-feature) (`rv_yale`) | Hard | genomics | cDNA | 165 / 1,024 | V21_WINNER | 0.55-0.72 (within) |
