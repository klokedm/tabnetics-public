...
The current HDLSS browser bundle exposes **56,107** run rows across **278** profiles and **63** datasets.
...
| Val-21 Phase 1 | `val21_phase1` | Targeted slice | 7 | 43 | Val-21 Current Default, Val-21 Integrated, Val-21 Winner, Val-21 Winner Lockout, Val-21 Winner Meta-Selector, Val-21 Winner Prefilter, Val-21 Winner Regime | Public browser slice for this campaign. |
...
| Val-21 Current Default | `V21_CURRENT_DEFAULT` | 1 | 43 | Targeted slice | Val-21 Phase 1 | Public browser family in the benchmark bundle. |
| Val-21 Integrated | `V21_INTEGRATED` | 1 | 43 | Targeted slice | Val-21 Phase 1 | Public browser family in the benchmark bundle. |
| Val-21 Winner | `V21_WINNER` | 1 | 43 | Targeted slice | Val-21 Phase 1 | Public browser family in the benchmark bundle. |
| Val-21 Winner Lockout | `V21_WINNER_LOCKOUT` | 1 | 43 | Targeted slice | Val-21 Phase 1 | Public browser family in the benchmark bundle. |
| Val-21 Winner Meta-Selector | `V21_WINNER_METASEL` | 1 | 26 | Targeted slice | Val-21 Phase 1 | Public browser family in the benchmark bundle. |
| Val-21 Winner Prefilter | `V21_WINNER_PREFILTER` | 1 | 26 | Targeted slice | Val-21 Phase 1 | Public browser family in the benchmark bundle. |
| Val-21 Winner Regime | `V21_WINNER_REGIME` | 1 | 7 | Targeted slice | Val-21 Phase 1 | Public browser family in the benchmark bundle. |
