...
**TabArena snapshot refreshed.** The published general-tabular comparison now uses the latest merged 38-dataset TabArena run: **Elo 1012.1**, **binary Elo 1008.3**, **multiclass Elo 1027.3**, and **3 wins / 35 losses / 0 ties** against the current official dataset-best rows. See [TABARENA_RESULTS.md](TABARENA_RESULTS.md) for details.
