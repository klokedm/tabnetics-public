...
- `def configure_runtime_environment() -> None` (function) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/core/runtime.py#L29). Apply BLAS and CUDA safety defaults before heavy imports.
...
- `def get_sklearn_n_jobs() -> int` (function) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/core/runtime.py#L42). Get the thread-local sklearn n_jobs value.
- `def set_sklearn_n_jobs(n_jobs: int = 1) -> None` (function) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/core/runtime.py#L37). Set the thread-local sklearn n_jobs value used across the package.
