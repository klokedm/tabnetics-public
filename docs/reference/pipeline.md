...
- `class DFFSConfig` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L514).
...
- `class DistributionFeatureSelectionPipeline` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L2605). Integrated DF+FS pipeline with strict leakage-safe protocol.
...
- `class ClassificationConfig` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L372). Stage-2 classifier backend configuration.
- `class DFFSConfig` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L514).
- `class PipelineRunResult` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L1427).
- `class DFFSReproducibleModel` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L1616). Inference helper that can be reconstructed from a JSON model bundle.
- `def load_df_fs_model_bundle(path: str) -> DFFSReproducibleModel` (function) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L1976).
- `class DistributionFitter` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L2074). Wrapper around UnifiedDistributionSelectorV6 with auditing and diagnostics.
- `class DistributionFeatureSelectionPipeline` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L2605). Integrated DF+FS pipeline with strict leakage-safe protocol.
