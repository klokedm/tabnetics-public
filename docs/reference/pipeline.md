...
- `class DistributionFeatureSelectionPipeline` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L2761). Integrated DF+FS pipeline with strict leakage-safe protocol.
...
- `class ClassificationConfig` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L378). Stage-2 classifier backend configuration.
- `class DFFSConfig` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L562).
- `class PipelineRunResult` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L1583).
- `class DFFSReproducibleModel` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L1772). Inference helper that can be reconstructed from a JSON model bundle.
- `def load_df_fs_model_bundle(path: str) -> DFFSReproducibleModel` (function) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L2132).
- `class DistributionFitter` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L2230). Wrapper around UnifiedDistributionSelectorV6 with auditing and diagnostics.
- `class DistributionFeatureSelectionPipeline` (class) - [Source](https://github.com/klokedm/tabnetics-public/blob/main/src/tabnetics/pipeline/pipeline.py#L2761). Integrated DF+FS pipeline with strict leakage-safe protocol.
