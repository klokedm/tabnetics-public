...
>
  <div class="tn-browser-shell">
    ...
    <section class="tn-browser-tabs" role="tablist" aria-label="Results browser tabs">
      ...
      <button class="tn-browser-tab" type="button" data-tab="auto-router">Auto Router</button>
    ...
    <section class="tn-browser-panel" id="tn-panel-auto-router" data-panel="auto-router">
      <div class="tn-browser-metrics" id="tn-router-metrics"></div>

      <div class="tn-browser-grid">
        <article class="tn-browser-card">
          <div class="tn-browser-card-head">
            <h3>V25 policy slices</h3>
            <p>Training-CV aggregate and the latest available frozen-router holdout context.</p>
          </div>
          <div class="tn-browser-table" id="tn-router-summary-table"></div>
        </article>

        <article class="tn-browser-card">
          <div class="tn-browser-card-head">
            <h3>Candidate selection counts</h3>
            <p>How often each supported V25 candidate was selected by the calibrated policy.</p>
          </div>
          <div class="tn-browser-chart" id="tn-router-candidate-chart"></div>
        </article>

        <article class="tn-browser-card tn-browser-span-2">
          <div class="tn-browser-card-head">
            <h3>Training datasets</h3>
            <p>Out-of-fold V25 policy deltas against the current default, aggregated by dataset.</p>
          </div>
          <div class="tn-browser-table" id="tn-router-dataset-table"></div>
        </article>
      </div>
    </section>
