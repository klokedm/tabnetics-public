...
| SOTA comparison: above / within / below | 31 / 22 / 10 |
...
| Discounted (close protocol) | 36 | 16 | 15 | 5 |
| Proxy (positioning only) | 17 | 9 | 4 | 4 |
| **Total** | **63** | **31** | **22** | **10** |

Val-18 best profiles **exceed** published strict-holdout ranges on 31 of 63 datasets (49%) and reach or exceed them on 53 of 63 (84%). The 10 below-range datasets concentrate in hard and very-hard tiers — genomic multi-class problems where class counts and small sample sizes push the pipeline's limits.
...
| gla_bra_180 | 0.58–0.72 | within | [James & Dimitrijev 2012](https://hcis-journal.springeropen.com/articles/10.1186/2192-1962-2-12/tables/1) |
