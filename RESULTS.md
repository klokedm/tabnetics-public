...
> **Status:** These results are from validation campaigns Val-18, Val-19, and Val-20, run during active development. A peer-reviewed article with full methodology, ablation studies, and statistical analysis is in preparation.
...
Results below are from the reconciled **Val-18** / **Val-19** / **Val-20** evidence base — combined validation campaigns with **54,882** successful runs across **271** pipeline profiles, after duplicate cleanup and loader hardening.
...
| Pipeline profiles evaluated | 271 |
| Total runs (dataset × seed × profile) | 54,882 |
| Datasets with BA ≥ 0.90 | 31 / 63 |
| Datasets with BA ≥ 0.80 | 40 / 63 |
| Perfect classification (BA = 1.0) | 8 datasets |
| SOTA comparison: above / within / below | 29 / 26 / 8 |

---

## Dataset difficulty spectrum

The 63 benchmark datasets span a wide difficulty range. Each bar shows the best balanced accuracy achieved across all 271 profiles.

![Dataset Difficulty Spectrum](figures/public/dataset_difficulty_spectrum.png)
...
![Profile BA Distribution by Family](figures/public/family_overview.png)
...
| Val-20 pipeline | 6 | Narrow pipeline simplification probes |
| Val-20 TabPFN | 2 | Targeted TabPFN gating checks |
...
Val-19 and Val-20 are narrower follow-on campaigns rather than replacements for the broad Val-18 surface. The figure below shows the strongest current bridge/frontier family anchors across those newer campaigns.

![Cross-campaign Frontier](figures/public/campaign_frontier.png)

The important read is directional rather than promotional: the newer FLAML, tune-first, ensemble, and pipeline lanes are promising on focused slices, but the broad catalog anchor still comes from the mature Val-18 base.
...
| BASEHOCK Text | 1,993 | 4,862 | 2 | **0.968** | [Scikit-feature](https://jundongl.github.io/scikit-feature/) |
| ORLraws10P (Face) | 100 | 10,304 | 10 | **0.961** | Scikit-feature |
| DLBCL (Shipp) | 77 | 5,469 | 2 | **0.950** | [OpenML](https://www.openml.org/d/1102) |
| warpPIE10P (Face) | 210 | 2,420 | 10 | **0.963** | Scikit-feature |
| pixraw10P (Face) | 100 | 10,000 | 10 | **0.956** | Scikit-feature |
...
| CuMiDa Colorectal (GSE44861) | 111 | 22,277 | 2 | **0.937** | [GEO](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE44861) |
| DEXTER (NIPS 2003) | 600 | 20,001 | 2 | **0.922** | [OpenML](https://www.openml.org/d/4136) |
| CuMiDa Pancreatic (GSE16515) | 52 | 54,613 | 2 | **0.969** | [GEO](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE16515) |
| TOX_171 | 171 | 5,748 | 4 | **0.905** | [Scikit-feature](https://jundongl.github.io/scikit-feature/) |
| GLI_85 Glioma | 85 | 22,283 | 2 | **0.890** | [OpenML](https://www.openml.org/d/1111) |
| CLL_SUB_111 | 111 | 11,340 | 3 | **0.886** | [Scikit-feature](https://jundongl.github.io/scikit-feature/) |
...
| Brain Tumor 2 (Nutt) | 50 | 12,625 | 4 | **0.833** | [PubMed](https://pubmed.ncbi.nlm.nih.gov/12670911/) |
| CuMiDa Prostate (GSE6919) | 171 | 12,625 | 2 | **0.809** | [GEO](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE6919) |
| Glioma 4-class | 50 | 4,434 | 4 | 0.750 | [Scikit-feature](https://jundongl.github.io/scikit-feature/) |
| SMK_CAN_187 | 187 | 19,993 | 2 | 0.753 | [OpenML](https://www.openml.org/d/1095) |
| Breast Cancer (van ’t Veer) | 97 | 24,481 | 2 | 0.693 | [OpenML](https://www.openml.org/d/1168) |
| CNS / Brain (Pomeroy) | 60 | 7,129 | 2 | 0.713 | [OpenML](https://www.openml.org/d/1100) |
...
| Lung Cancer (Gordon) | 203 | 12,600 | 5 | **0.983** | [OpenML](https://www.openml.org/d/1109) |
...
| 11-Tumor (Su) | 174 | 12,533 | 11 | **0.967** | [OpenML](https://www.openml.org/d/1113) |
...
| TCGA-LUAD Lung | 275 | 20,530 | 3 | 0.776 | [UCSC Xena](https://xenabrowser.net/) |
| TCGA-GBM Glioblastoma | 164 | 20,530 | 4 | 0.767 | [UCSC Xena](https://xenabrowser.net/) |
| Breast Gene Expression (HF) | 51 | 28,278 | 2 | 0.667 | [HuggingFace](https://huggingface.co/datasets/mubashir1837/Breast_cancer_gene_expression) |
| TCGA-COAD Colorectal | 323 | 20,530 | 2 | 0.756 | [UCSC Xena](https://xenabrowser.net/) |
| GCM (Ramaswamy) | 198 | 16,063 | 14 | 0.709 | [OpenML](https://www.openml.org/d/1112) |
| GLA-BRA-180 | 180 | 49,151 | 4 | 0.679 | [Scikit-feature](https://jundongl.github.io/scikit-feature/) |
| TCGA-UCEC Uterine | 190 | 20,530 | 3 | 0.623 | [UCSC Xena](https://xenabrowser.net/) |
...
| TCGA-LGG Glioma | 529 | 20,530 | 3 | 0.574 | [UCSC Xena](https://xenabrowser.net/) |
| TCGA-STAD Stomach | 448 | 20,530 | 3 | 0.549 | [UCSC Xena](https://xenabrowser.net/) |
| 9-Tumors | 60 | 5,726 | 9 | 0.493 | [OpenML](https://www.openml.org/d/1114) |
...
| TCGA-KIRC Kidney | 606 | 20,530 | 4 | 0.403 | [UCSC Xena](https://xenabrowser.net/) |
| TCGA-PRAD Prostate | 550 | 20,530 | 5 | 0.503 | [UCSC Xena](https://xenabrowser.net/) |
...
![Oracle Weighting Hierarchy](figures/public/oracle_weighting_hierarchy.png)
...
![Engineered FS vs Random Baseline](figures/public/fs_vs_random_volcano.png)
...
![Classifier Rankings](figures/public/classifier_rankings.png)

Completed cross-campaign `C_ONLY` slices still favor the simpler linear / DA core overall: LR, TabPFN on moderate-regime slices, elastic-net LR, shrinkage/DLDA, and a few ensemble or tuned standard-regime baselines define the current top tier. The public classifier surface is broader than this leaderboard alone, though: specialist additions such as nearest-subspace, spatial-median DA, copula-style DA, HDRDA-style regularized discriminants, DWD, sparse PLS-DA, ECOC wrappers, and the TabM / RealMLP paths are now documented and available. At the current reconciled evidence-base cutoff, the newer specialist backends should be read as **targeted regime options** rather than universally promoted replacements, while SGLNN and dense PLS-DA remain the clearest trailing baselines in the comparable `C_ONLY` slices. For a detailed cross-campaign technical report covering all 271 profiles, see [the documentation site](https://tabnetics.org/RESULTS.html).

---

## SOTA comparison

Best profiles from the reconciled Val-18/Val-19/Val-20 evidence base are compared to published results for each dataset. Comparison confidence is categorized by protocol match quality (direct = independent test set; discounted = CV/LOOCV literature; proxy = no exact-task benchmark).

![SOTA Comparison Chart](figures/public/sota_comparison.png)
...
The reconciled Val-18/Val-19/Val-20 best profiles **exceed** published strict-holdout ranges on 29 of 63 datasets (46%) and reach or exceed them on 55 of 63 (87%). The 8 below-range datasets concentrate in hard and very-hard tiers — genomic multi-class problems where class counts and small sample sizes push the pipeline’s limits.
...
| dlbcl_shipp | 0.90–0.98 | within | [Shipp et al. 2002](https://www.nature.com/articles/nm0102-68); [Alweshah et al. 2026](https://doi.org/10.1038/s41598-026-37803-5) |
...
| cns_pomeroy | 0.74–0.86 | below | [Pomeroy et al. 2002](https://pubmed.ncbi.nlm.nih.gov/11807556/); [Alrefai & Ibrahim 2022](https://doi.org/10.1007/s00521-022-07276-4) |
| lung_gordon | 0.75–0.88 | above | [Elemam & Elshrkawey 2022](https://doi.org/10.1155/2022/1056490) |
| breast_vantveer | 0.75–0.87 | below | [van 't Veer et al. 2002](https://pubmed.ncbi.nlm.nih.gov/11823860/); [Alrefai & Ibrahim 2022](https://doi.org/10.1007/s00521-022-07276-4) |
...
| cll_sub_111 | 0.78–0.90 | within | [G3CS 2021](https://pmc.ncbi.nlm.nih.gov/articles/PMC8382518/); [Alsaeedi et al. 2024](https://pmc.ncbi.nlm.nih.gov/articles/PMC10775438/) |
| tox_171 | 0.84–0.93 | within | [Alsaeedi et al. 2024](https://pmc.ncbi.nlm.nih.gov/articles/PMC10775438/) |
| brain_tumor_2 | 0.86–0.95 | below | [Nutt et al. 2003](https://pubmed.ncbi.nlm.nih.gov/12670911/); [Statnikov et al. 2005](https://pubmed.ncbi.nlm.nih.gov/15374862/) |
...
| tumor9_openml | 0.45–0.65 | within | [Statnikov et al. 2005](https://pubmed.ncbi.nlm.nih.gov/15374862/); [Berrar et al. 2006](https://doi.org/10.1186/1471-2105-7-73); [Zeng et al. 2025](https://doi.org/10.1038/s41598-025-89475-2) |
...
| gla_bra_180 | 0.58–0.72 | within | [James & Dimitrijev 2012](https://research-repository.griffith.edu.au/bitstreams/6c8fdc24-bc11-56e1-bdf8-45726cccd6a6/download); [Lee et al. 2024](https://doi.org/10.3390/app14083156) |
| glioma_50_4class | 0.88–0.97 | below | Scikit-feature benchmark family |
| arcene_nips03 | 0.75–0.89 | within | [Guyon et al. NIPS 2003](https://proceedings.neurips.cc/paper/2728-result-analysis-of) |
...
| pixraw10p | 0.96–1.00 | below | [SVFS 2021](https://pmc.ncbi.nlm.nih.gov/articles/PMC7884742/) |
...
| cumida_brain_gse50161 | 0.88–0.98 | within | [Northcott et al. 2020](https://pmc.ncbi.nlm.nih.gov/articles/PMC7654754/); [Khan 2025](https://arxiv.org/abs/2506.00053) |
...
| cumida_lung_gse19804 | 0.85–0.95 | within | [DRW validation](https://academic.oup.com/bioinformatics/article-abstract/29/17/2169/245913) |
...
| xena_tcga_ucec | 0.50–0.68 | within | [TCGA UCEC 2013](https://pubmed.ncbi.nlm.nih.gov/23636398/) |
...
| xena_tcga_stad | 0.58–0.75 | below | [TCGA STAD 2014](https://pubmed.ncbi.nlm.nih.gov/25079317/) |
| xena_tcga_lihc | 0.52–0.68 | below | [TCGA LIHC 2017](https://pubmed.ncbi.nlm.nih.gov/28622513/); [Kaur et al. 2019](https://pubmed.ncbi.nlm.nih.gov/31490960/) |
| xena_tcga_ov | 0.48–0.65 | within | [TCGA OV 2011](https://pubmed.ncbi.nlm.nih.gov/21720365/) |
...
| hf_breast_ge | 0.50–0.70 | within | Dataset-export proxy |
