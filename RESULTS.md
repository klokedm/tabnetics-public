...
Results below are from the latest merged **Val-18** (`52,022` rows) and **Val-19** (`3,095` rows) mirrors — combined validation campaigns with **55,117** successful runs across **210** pipeline profiles.
...
| Pipeline profiles evaluated | 210 |
| Total runs (dataset × seed × profile) | 55,117 |
| Datasets with BA ≥ 0.90 | 31 / 63 |
| Datasets with BA ≥ 0.80 | 41 / 63 |
| Perfect classification (BA = 1.0) | 7 datasets |
| SOTA comparison: above / within / below | 33 / 19 / 11 |

---

## Dataset difficulty spectrum

The 63 benchmark datasets span a wide difficulty range. Each bar shows the best balanced accuracy achieved across all 210 profiles.
...
| TCGA-BRCA Breast | 956 | 20,530 | 5 | **0.911** | [UCSC Xena](https://xenabrowser.net/) |
...
Val-18 best profiles are compared to published results for each dataset. Comparison confidence is categorized by protocol match quality (direct = independent test set; discounted = CV/LOOCV literature; proxy = no exact-task benchmark).

![SOTA Comparison Chart](figures/public/sota_comparison.png)

Each marker shows tabnetics' best balanced accuracy against the published strict-holdout range (gray bar). Marker shape encodes source confidence; color encodes status (green = above, blue = within, red = below).

| Confidence Level | Datasets | Above SOTA | Within Range | Below SOTA |
|---|---|---|---|---|
| Direct (protocol-matched) | 10 | 6 | 3 | 1 |
| Discounted (close protocol) | 37 | 19 | 11 | 7 |
| Proxy (positioning only) | 16 | 8 | 5 | 3 |
| **Total** | **63** | **33** | **19** | **11** |

The latest merged Val-18/Val-19 best profiles **exceed** published strict-holdout ranges on 33 of 63 datasets (52%) and reach or exceed them on 52 of 63 (83%). The 11 below-range datasets concentrate in hard and very-hard tiers — genomic multi-class problems where class counts and small sample sizes push the pipeline's limits.
...
| cll_sub_111 | 0.78–0.90 | below | [G3CS 2021](https://pmc.ncbi.nlm.nih.gov/articles/PMC8382518/); [Alsaeedi et al. 2024](https://pmc.ncbi.nlm.nih.gov/articles/PMC10775438/) |
...
| tumor9_openml | 0.40–0.62 | within | [Zeng et al. 2025](https://doi.org/10.1038/s41598-025-89475-2) |
| nci60_ross | 0.40–0.55 | within | [Yeung et al. 2006](https://pubmed.ncbi.nlm.nih.gov/16483361/); [Li et al. 2004](https://pubmed.ncbi.nlm.nih.gov/15087314/) |
| nci60_strict_holdout | 0.30–0.50 | above | [Li et al. 2004](https://pubmed.ncbi.nlm.nih.gov/15087314/) |
| nci9_60_9class | 0.35–0.52 | above | [BPRGO 2025](https://link.springer.com/article/10.1186/s40537-025-01066-0) |
...
| gla_bra_180 | 0.58–0.72 | below | [James & Dimitrijev 2012](https://hcis-journal.springeropen.com/articles/10.1186/2192-1962-2-12/tables/1) |
...
| warp_pie10p | 0.95–1.00 | below | [SVFS 2021](https://pmc.ncbi.nlm.nih.gov/articles/PMC7884742/) |
...
| cumida_leukemia_subtypes | 0.00–0.49 | above | [CuMiDa 2019](https://doi.org/10.1089/cmb.2018.0238); [Ilyas et al. 2025](https://doi.org/10.1371/journal.pone.0320669) |
...
| cumida_prostate_gse6919 | 0.62–0.78 | within | [GSE6919 study](https://www.sciencedirect.com/science/article/pii/S1110866519301793) |
...
| cumida_colorectal_gse44861 | 0.88–0.96 | above | [CRC external validation](https://pmc.ncbi.nlm.nih.gov/articles/PMC8944988/) |
...
| cumida_pancreatic_gse16515 | 0.80–0.92 | within | [GSE16515 cohort paper](https://pmc.ncbi.nlm.nih.gov/articles/PMC6842480/) |
...
| xena_tcga_skcm | 0.78–0.90 | above | [Bhalla et al. 2019](https://doi.org/10.1038/s41598-019-52134-4) |
