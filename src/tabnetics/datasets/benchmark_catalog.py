...
KNOWN_SOTA_PROTOCOL_RANGES: Dict[str, Dict[str, Tuple[float, float]]] = {
    ...
    "cumida_brain_gse50161": {"strict_holdout": (0.70, 0.88), "inflated": (0.82, 0.96)},
    "cumida_breast_gse45827": {"strict_holdout": (0.55, 0.72), "inflated": (0.70, 0.90)},
    "cumida_leukemia_subtypes": {"strict_holdout": (0.00, 0.49), "inflated": (0.70, 1.00)},
    ...
    "cll_sub_111": {"strict_holdout": (0.88, 0.95), "inflated": (0.95, 0.98)},
    "tox_171": {"strict_holdout": (0.84, 0.93), "inflated": (0.93, 0.98)},
    "gla_bra_180": {"strict_holdout": (0.70, 0.82), "inflated": (0.82, 0.90)},
    ...
    "cumida_prostate_gse6919": {"strict_holdout": (0.80, 0.92), "inflated": (0.88, 0.97)},
    "cumida_ovarian_gse26712": {"strict_holdout": (0.80, 0.92), "inflated": (0.88, 0.97)},
    "cumida_lung_gse19804": {"strict_holdout": (0.85, 0.95), "inflated": (0.92, 0.99)},
    "cumida_colorectal_gse44861": {"strict_holdout": (0.78, 0.90), "inflated": (0.85, 0.95)},
    ...
    "xena_tcga_skcm": {"strict_holdout": (0.60, 0.78), "inflated": (0.75, 0.92)},
