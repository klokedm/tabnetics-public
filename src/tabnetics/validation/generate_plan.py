...
def main() -> None:
            ...
            "validation21_host_policy": (
                {
                    ...
                    "host_worker_targets": dict(VAL21_HOST_WORKER_TARGETS),
                    "recommended_host_assignment": _validation21_recommended_host_assignment(shards, jobs_by_id),
                }
                if plan_kind in set(VALIDATION21_PLAN_KINDS)
                else {}
            ),
    ...
    shard_doc = {
        ...
        "validation21_recommended_host_assignment": (
            _validation21_recommended_host_assignment(shards, jobs_by_id)
            if plan_kind in set(VALIDATION21_PLAN_KINDS)
            else {}
        ),
    }
