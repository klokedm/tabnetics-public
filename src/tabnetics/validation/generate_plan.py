...
def _write_work_split_md(path: Path, *, shards: Dict[int, List[str]], jobs_by_id: Dict[str, Job]) -> None:
    ...
    if all_job_ids and all(str(jid).startswith("val19_") for jid in all_job_ids):
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="",
        help=(
            "(validation18_*/validation19_classifiers) Path to Val-17 output directory containing "
    ...
    if plan_kind.startswith("validation18"):
