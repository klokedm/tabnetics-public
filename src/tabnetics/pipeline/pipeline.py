...
class DFFSConfig:
    ...
    # V25 packaged score router. Enabled by default for 1.1.0 so callers get a
    # dataset-calibrated method/config selection without manual flags.
    ...
    def __post_init__(self) -> None:
        ...
        self.auto_router_enabled = bool(getattr(self, "auto_router_enabled", True))
...
class DistributionFeatureSelectionPipeline:
    ...
    def _resolve_meta_learning_runtime_config(
        ...
        if bool(getattr(self.config, "auto_router_enabled", True)):
    ...
    def _config_snapshot(self) -> Dict[str, Any]:
        return {
            ...
            "auto_router_enabled": bool(
                getattr(self.config, "auto_router_enabled", True)
            ),
            "auto_router_artifact_path": str(
