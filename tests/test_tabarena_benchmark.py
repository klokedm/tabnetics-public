...
from experiments.benchmarking.tabarena_datasets import TABARENA_DATASETS  # noqa: E402
...
def test_general_tabular_profile_uses_tree_weighted_pool_and_skips_hdlss() -> None:
    ...
    # Val-18 evidence: Banzhaf weighting for both FS and classifier oracles
    assert cfg.classification.oracle_weighting_mode == "banzhaf"
