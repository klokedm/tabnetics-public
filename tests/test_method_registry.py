...
class TestMethodRegistry:
    ...
    def test_known_method_count(self):
        """Current registry includes default-off DIAKRINO and pathway/group surfaces."""
        assert len(METHOD_REGISTRY) == 44
    ...
    def test_experimental_methods_match_old_set(self):
        """Experimental method set remains explicit after default-off additions."""
        expected_set = {
            ...
            'oaenet', 'treeshap',
            'random',
            'group_sparse_lasso', 'pathway_group_sparse_lasso',
            'diakrino_prior', 'diakrino_screening_prior', 'diakrino_conformal_selection',
        }
        assert get_experimental_keys() == expected_set
